...
\newcommand{\outDate}{Jan. 15, 2025}
\newcommand{\dueDate}{Jan. 27, 2025}
\newcommand{\taNames}{Abishek, Aarav, Jinxuan, Aravind, Natalie}
...
\part[1]  How does PyTorch's autograd system compute gradients, and why is this feature essential for training neural networks?
...
\part[1] Why is it beneficial to use something like wandb.log() over just printing the loss or accuracy every epoch?
...
\part[1] What do the MaxLen and PadSequence classes do in txt\_classifier.py? Explain when and why each one is used.
